...
public class SendRequest extends UriBase{
	...
	public void registerUser() throws FileNotFoundException, IOException {
		String email=ReadExcelData.readDataFromExcel("src/test/resources/Data.xlsx","TestData",1,0);
		String password=ReadExcelData.readDataFromExcel("src/test/resources/Data.xlsx","TestData",1,0);
